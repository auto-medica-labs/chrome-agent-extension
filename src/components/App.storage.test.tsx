...
import { render, cleanup, resetChromeStore } from "../test-utils";
import { App } from "./App";
...
describe("App with storage", () => {
  ...
  it("shows chat when a valid profile exists in storage", async () => {
    // @ts-expect-error access internal store via chrome mock
    global.chrome.storage.local.set({
      profiles: [
        { id: "1", name: "OpenAI", baseUrl: "https://api.openai.com", model: "gpt-4", apiKey: "sk-test" },
      ],
    });
